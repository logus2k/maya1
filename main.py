...
def main():
    ...
    snac_model = SNAC.from_pretrained("models/snac_24khz", local_files_only=True).eval()
    ...
    text = "<angry> Arrr, gather 'round, ye scurvy dogs and landlubbers! <laugh> I be Captain Jack Sparrow, the notorious wolf of the Seven Seas! <whisper> Been sailin' these waters fer nigh on forty years now!"
